package com.example.skala.global.exception.handler;

import com.example.skala.global.apiPayload.ApiResponse;
import com.example.skala.global.apiPayload.code.FailureCode;
...
public class ExceptionAdvice {
    ...
    public ResponseEntity<ApiResponse<List<String>>> constraintViolationException(ConstraintViolationException e) {
        ...
        return ResponseEntity.status(reasonDTO.getHttpStatus())
                .body(ApiResponse.onFailure(reasonDTO.getCode(), reasonDTO.getMessage(), message));
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, String>>> methodArgumentNotValidException(
        ...
        return ResponseEntity.status(dto.getHttpStatus())
                .body(ApiResponse.onFailure(dto.getCode(), dto.getMessage(), error));
    }
    ...
    public ResponseEntity<ApiResponse<String>> generalException(GeneralException e) {
        ...
        return ResponseEntity.status(dto.getHttpStatus())
                .body(ApiResponse.onFailure(dto.getCode(), dto.getMessage(), null));
    }
    ...
    public ResponseEntity<ApiResponse<String>> exception(Exception e) {
        ...
        return ResponseEntity.status(dto.getHttpStatus())
                .body(ApiResponse.onFailure(dto.getCode(), dto.getMessage(), message));
    }
}
